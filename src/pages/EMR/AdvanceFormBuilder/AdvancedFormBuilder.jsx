                ...
                <Card className="form-builder-card">
                  ...
                  <div className="form-builder-form-settings">
                    <div className="form-builder-form-setting">
                      <Label htmlFor="form-title" className="form-builder-label">Form Title</Label>
                      <Input
                        id="form-title"
                        value={config.title}
                        onChange={(e) => setConfig({ ...config, title: e.target.value })}
                        className="mt-1 form-builder-input"
                      />
                    </div>
                    ...
                    <TabsContent value="basic" className="form-builder-tabs-content">
                      <div className="form-builder-properties-content">
                        <div className="form-builder-field-setting">
                          <Label htmlFor="field-label" className="form-builder-label">Label</Label>
                          <Input
                            id="field-label"
                        ...
                        <div className="form-builder-field-setting">
                          <Label htmlFor="field-placeholder" className="form-builder-label">Placeholder</Label>
                          <Input
                        ...
                        {selectedField.type === "number" && (
                          <>
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-min" className="form-builder-label">Minimum Value</Label>
                              <Input
                                id="field-min"
                                type="number"
                            ...
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-max" className="form-builder-label">Maximum Value</Label>
                              <Input
                                id="field-max"
                                type="number"
                            ...
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-step" className="form-builder-label">Step</Label>
                              <Input
                                id="field-step"
                                type="number"
                        ...
                        {(selectedField.type === "date" || selectedField.type === "datetime" || selectedField.type === "time") && (
                          <>
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-min-date" className="form-builder-label">Minimum Date/Time</Label>
                              <Input
                                id="field-min-date"
                            ...
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-max-date" className="form-builder-label">Maximum Date/Time</Label>
                              <Input
                                id="field-max-date"
                                type={selectedField.type}
                                value={selectedField.max || ""}
                        ...
                        {selectedField.type === "textarea" && (
                          <div className="form-builder-field-setting">
                            <Label htmlFor="field-rows" className="form-builder-label">Rows</Label>
                            <Input
                              id="field-rows"
                              type="number"
                        ...
                        {(selectedField.type === "file" || selectedField.type === "image") && (
                          <div className="form-builder-field-setting">
                            <Label htmlFor="field-accept" className="form-builder-label">Accept File Types</Label>
                            <Input
                              id="field-accept"
                        ...
                        {selectedField.type === "table" && (
                          <>
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-rows" className="form-builder-label">Number of Rows</Label>
                              <Input
                                id="field-rows"
                                type="number"
                            ...
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-columns" className="form-builder-label">Number of Columns</Label>
                              <Input
                                id="field-columns"
                                type="number"
                        ...
                        {(selectedField.type === "signature" || selectedField.type === "annotation") && (
                          <>
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-width" className="form-builder-label">Width</Label>
                              <Input
                                id="field-width"
                                type="number"
                            ...
                            <div className="form-builder-field-setting">
                              <Label htmlFor="field-height" className="form-builder-label">Height</Label>
                              <Input
                                id="field-height"
                                type="number"
                        ...
                        {selectedField.type === "tabs" && (
                          <div className="form-builder-field-setting">
                            <Label className="form-builder-label">Tab Names</Label>
                            <div className="form-builder-options">
                              {selectedField.options?.map((option, index) => (
                                <Input
                                  key={index}
