...
const GuestConsentForm = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      if (!formId) {
        alert("Form is not ready to be submitted yet. Please wait...");
        return;
      }
      ...
      if (!hasMeaningfulData) {
        alert("Form is blank. Please fill out at least one field before submitting.");
        return;
      }
            ...
            <form className="form-grid" onSubmit={handleSubmit}>
                ...
                <fieldset>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
                    ...
                    <label>Primary Physician: <input type="text" name="physician" /></label>
                ...
                <fieldset>
                    ...
                    <div className="radio-group" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', textAlign: 'left' }}>
                        ...
                        <label><input type="radio" name="fitzpatrick" value="light" /> Light Skin Tones - can burn, sometimes tans</label>
                        <label><input type="radio" name="fitzpatrick" value="light-brown" /> Light brown skin - burns minimally, tans easily</label>
                        <label><input type="radio" name="fitzpatrick" value="medium" /> Medium to Olive skin tone - tans easily</label>
                        <label><input type="radio" name="fitzpatrick" value="brown" /> Brown Skin - rarely burns, tans darkly easily</label>
                        <label><input type="radio" name="fitzpatrick" value="dark" /> Dark brown or black skin - never burns, always tans darkly</label>
                    </div>
                </fieldset>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <div className="radio-group">
                                    <label><input type="radio" name="papStatus" value="normal" /> normal</label>
                                    <label><input type="radio" name="papStatus" value="abnormal" /> abnormal</label>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="radio-group">
                                    ...
                                    <label><input type="radio" name="abnormalPap" value="no" /> No</label>
                                </div>
                                <label>If yes, When?</label>
                                <input type="date" name="abnormalPapDate" />
                            </div>
                        </div>
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <div className="radio-group">
                                    <label><input type="radio" name="mammogramStatus" value="normal" /> normal</label>
                                    <label><input type="radio" name="mammogramStatus" value="abnormal" /> abnormal</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div style={{ gap: '1rem', textAlign: 'left' }}>
                        {['Skin/Light Energy Treatments At Another Office', 'Neurotoxin (Botox, Dysport etc.)', 'Fillers (Restylane, Juvederm etc.)', 'Hair Removal', 'Chemical Peels', 'Sun Exposure/Tanning bed in last week? Tanning Habits'].map((item, idx) => (
                            <fieldset key={idx}>
                                ...
                                <label>Results <input type="text" name={`results-${idx}`} /></label>
                            </fieldset>
                        ))}
                    </div>
                    ...
                    <fieldset>
                        ...
                        <div style={{ gap: '1rem', textAlign: 'left' }}>
                            {[
                                ...
                                <label key={`concern-${idx}`}><input type="checkbox" name="concerns" /> {item}</label>
                            ))}
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        <label>BEFORE File Upload</label>
                ...
                <section>
                    <div className="form-row">
                        ...
                        <label>Date Signed:<input type="date" name="guestDateSigned" defaultValue="2025-07-10" /></label>
                    </div>
                    ...
                    <div className="form-row">
                        <label>Provider Name:<input type="text" name="providerName" /></label>
                        <label>Date Signed:<input type="date" name="providerDateSigned" defaultValue="2025-07-10" /></label>
                    </div>
                    <div className="form-row signature-row">
