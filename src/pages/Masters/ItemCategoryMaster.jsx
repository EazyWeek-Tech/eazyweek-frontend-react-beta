...
const ItemCategoryMaster = () => {
  ...
  const itemCategories = [
    ...
    { code: "C11", name: "Asset" },
    { code: "C7", name: "Retail" },
    { code: "C6", name: "Peeling" },
    { code: "C5", name: "Consumable" },
    { code: "C1", name: "Computers" },
  ]

  // Sample data for Item Sub Categories
  const itemSubCategories = [
    { code: "CS35", name: "Medical Bed" },
    { code: "CS34", name: "Medical Device" },
    { code: "CS33", name: "Medical Machine" },
    { code: "CS32", name: "Plumbing" },
    { code: "CS31", name: "Electrical" },
    { code: "CS30", name: "HVAC" },
    { code: "CS14", name: "Medical" },
    { code: "CS13", name: "Mask" },
    { code: "CS11", name: "Cleanser" },
    { code: "CS8", name: "Home Care" },
  ]

  // Sample data for Item Sub Sub Categories
  const itemSubSubCategories = [
    { code: "CS54", name: "Medical Bed" },
    { code: "CS53", name: "NA" },
    { code: "CS51", name: "touch Screen Display" },
  ]

  // Sample data for Item Sub Sub Sub Categories
  const itemSubSubSubCategories = [{ code: "CS551", name: "NA" }]
