  ...
  const handleAdd = () => {
    ...
    if (serviceText) {
      ...
      onAddItem?.({
        ...
        taxIncluded:      selectedService.taxIncluded ?? 'No',
        loyaltyAccrual:   selectedService.allowLoyaltyAccrual    ?? 'Yes',
        loyaltyRedeem:    selectedService.allowLoyaltyRedemption ?? 'Yes',
    ...
    if (packageText) {
      ...
      onAddItem?.({
        ...
        taxIncluded:      selectedPackage.taxIncluded ?? 'No',
        loyaltyAccrual:   selectedPackage.allowLoyaltyAccrue ?? true,
        loyaltyRedeem:    selectedPackage.allowLoyaltyRedeem ?? true,
        practitionerName: selectedPract.fullName || practText,
        practitionerCode: selectedPract.practitionerCode || selectedPract.id || '',
      });
    ...
    if (productText) {
      ...
      onAddItem?.({
        ...
        taxIncluded:      selectedProduct.taxIncluded ?? 'No',
        practitionerName: selectedPract?.fullName || practText || '',
        practitionerCode: selectedPract?.practitionerCode || selectedPract?.id || '',
      });
